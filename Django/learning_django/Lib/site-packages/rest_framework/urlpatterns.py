from django.urls import URLResolver, include, path, path, register_converter
    ...
    for urlpattern in urlpatterns:
        if isinstance(urlpattern, URLResolver):
            ...
            if isinstance(urlpattern.pattern, RoutePattern):
                ...
                new_pattern = path(regex, include((patterns, app_name), namespace), kwargs)
            ...
            if isinstance(urlpattern.pattern, RoutePattern):
                ...
                new_pattern = path(regex, view, kwargs, name)
